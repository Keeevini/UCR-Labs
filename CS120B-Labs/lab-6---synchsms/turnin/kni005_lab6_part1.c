 ...
 *	Exercise Description: [Three LED Lights]
 *
 *	I acknowledge all content contained herein, excluding template or example
 *	code, is my own original work.
 *
 *	Demo Link: https://drive.google.com/file/d/1MjeF6YToz-LOdEcqiUSnb_BoDku1aDSp/view?usp=sharing
 */
...
enum SM_States { START, IDLE, SEQ_1, SEQ_2, SEQ_3 } SM_State;
