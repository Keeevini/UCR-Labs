 ...
 *	Exercise Description: [Off Tempo Lights]
 *
 *	I acknowledge all content contained herein, excluding template or example
 *	code, is my own original work.
 *
 *	Demo Link: https://drive.google.com/file/d/1ppJd1FCrtFqtVU5otDKCZTJCOjeg0HsA/view?usp=sharing
 */
...
int main(void) {
	...
	unsigned long count_1 = 3;
	unsigned long count_2 = 10;
