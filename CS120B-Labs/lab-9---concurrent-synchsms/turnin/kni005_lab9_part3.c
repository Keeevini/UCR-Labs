 ...
 *
 *	Demo Link: https://drive.google.com/file/d/1w7Nvo5qDZ9iia8aBAKVPsxzRvWS0oMR0/view?usp=sharing
 */
...
enum SM_States_3 { START3, SPEAKER_ON, SPEAKER_OFF } SM_State_3;
enum SM_States_4 { START4, OUTPUT } SM_State_4;
...
void tick3() {
	switch (SM_State_3) { // Transitions
		case START3:
			SM_State_3 = SPEAKER_OFF;
			break;
		case SPEAKER_OFF:
			if ( (tmpInput & 0x04) == 0x04) {
				counter_3 = 0x01;
				SM_State_3 = SPEAKER_ON;
			}
			break;
		case SPEAKER_ON:
