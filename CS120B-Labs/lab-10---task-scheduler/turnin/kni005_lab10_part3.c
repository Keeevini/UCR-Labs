 ...
 *	Exercise Description: [Doorbell]
 *
 *	I acknowledge all content contained herein, excluding template or example
 *	code, is my own original work.
 *
 *	Demo Link: https://drive.google.com/file/d/16tJCWfYkNp73cMwRqHOFWF2fvMBaKbKy/view?usp=sharing
 */
...
int main(void) {
    ...
    task tasks[2];
    const unsigned short tasks_size = 2;
