...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6da:	e8 fb fe ff ff       	call   5da <write>
  while(--i >= 0)
 ...
 70e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 743:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 746:	e8 8f fe ff ff       	call   5da <write>
 ...
 7b6:	e8 1f fe ff ff       	call   5da <write>
        putc(fd, c);
 ...
 7d0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 7d3:	e8 02 fe ff ff       	call   5da <write>
  for(i = 0; fmt[i]; i++){
 ...
 860:	e8 75 fd ff ff       	call   5da <write>
        while(*s != 0){
 ...
 890:	e8 45 fd ff ff       	call   5da <write>
 ...
 8e0:	e8 f5 fc ff ff       	call   5da <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 9ea:	e8 53 fc ff ff       	call   642 <sbrk>
  if(p == (char*)-1)
