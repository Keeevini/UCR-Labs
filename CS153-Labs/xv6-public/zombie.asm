...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37a:	e8 fb fe ff ff       	call   27a <write>
  while(--i >= 0)
 ...
 3ae:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 3e3:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 3e6:	e8 8f fe ff ff       	call   27a <write>
 ...
 456:	e8 1f fe ff ff       	call   27a <write>
        putc(fd, c);
 ...
 470:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 473:	e8 02 fe ff ff       	call   27a <write>
  for(i = 0; fmt[i]; i++){
 ...
 500:	e8 75 fd ff ff       	call   27a <write>
        while(*s != 0){
 ...
 530:	e8 45 fd ff ff       	call   27a <write>
 ...
 580:	e8 f5 fc ff ff       	call   27a <write>
        ap++;
